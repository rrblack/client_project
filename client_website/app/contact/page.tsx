    ...
    return(
        <section className="bg-gradient-to-br from-yellow-100 via-orange-100 to-pink-200 overflow-hidden ">
            <div className="relative w-full h-65 pt-16 flex justify-center">
                <div data-aos="fade-right"  className="absolute text-5xl text-black font-semibold after:content-[''] after:block after:w-5 after:bg-orange-500 after:h-1 after:mt-4 after:px-10 after:mx-auto pt-20 z-1">お問い合わせ</div>
            <img className="absolute w-full h-full rounded-sm object-cover" src="/banner.png" alt="" />
            </div>
        <div className=" bg-white shadow-lg mx-auto w-full px-10 py-10 pt-16 rounded-2xl">
        <form onSubmit={handleSubmit} className="text-2xl mb-5">
        <div className="mx-auto grid grid-col gap-4 w-full font-semibold">
            <h1 className="text-center text-xl mt-10 text-black font-semibold">弊社にご興味をお持ちいただき、誠にありがとうございます。こちらはお問い合わせ全般の窓口です。お問い合わせ内容を確認のうえ、通常 2営業日以内 にご返信いたします。</h1>
