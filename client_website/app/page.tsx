...
export default function Home() {
  ...
  <Banner/>
      ...
      <h1 className='text-5xl text-black font-bold text-center pb-2'>こんな不安、ありませんか？</h1>
      <div className='flex justify-center items-center mx-auto bg-gray-500/20 h-50 w-80 rounded-xl shadow-md mb-10 mt-10'>
      ...
      <h1 className='text-2xl text-orange-500 font-bold text-center pb-2'>その悩み、BIGO LIVEなら解決できます。</h1>
      </section>
      ...
      <section className="py-20 px-6 bg-white ">
        ...
        {/* メリット */}
      <section className='py-20 px-6 bg-white -mb-15'>
        ...
        <div className='container mx-auto grid md:grid-cols-3 p-4 items-start gap-12 my-12 '>
          <div className='p-10'>
            ...
            <div data-aos="fade-up" data-aos-duration="3000" className="flex justify-center items-center mx-auto my-8 w-50 h-50  object-cover rounded-full bg-pink-500 "> <span className='text-white text-8xl '> 1</span></div>
            ...
            <div data-aos="fade-up" data-aos-duration="3000" className="flex justify-center items-center mx-auto my-8 w-50 h-50  object-cover rounded-full bg-pink-500 "> <span className='text-white text-8xl '> 2</span></div>
            ...
            <div data-aos="fade-up" data-aos-duration="3000" className="flex justify-center items-center mx-auto my-8 w-50 h-50  object-cover rounded-full bg-pink-500 "> <span className='text-white text-8xl '> 3</span></div>
      ...
      {/*代表メッセージ*/}
      <section className='py-20 px-6 bg-gradient-to-bl from-orange-200 via-orange-100 to-yellow-100 pb-10'>
        <h1 className='text-5xl text-black font-bold text-center p-4'> 代表メッセージ</h1>
        <img className="w-100 h-100 mx-auto object-cover rounded-md shadow-md" src="/daihyou.png" alt="" /> 
        <h2 className='text-3xl text-black  text-center p-4'> 代表 永井大地より </h2>
        <div className='flex mx-auto justify-center items-center bg-white/40 w-200 h-150 p-8 gap-4 rounded-xl shadow-md'>
        <div className='w-150 text-center text-black text-xl p-6 container '>
      ...
      {/* 収入 */}
      <section className='py-20 px-6 bg-white'>
        <h1 className='text-5xl text-black font-bold text-center pb-2'>収入イメージ</h1>
        <h2 className='text-2xl text-black font-bold text-center p-8'> BIGO LIVEなら―― </h2>
        <div className='mx-auto flex flex-col md:flex-row items-center justify-center gap-6 pt-6 w-full h-full p-4'>
          <div className='flex justify-center items-center bg-gradient-to-br from-orange-400 via-orange-600 to-orange-400 w-75 h-50 rounded-xl p-4 shadow-lg'>
            <div className=''>
            <p className='text-2xl text-center font-semibold'>未経験スタート </p>
            <p className='text-3xl text-center p-4 font-black'>月3～10万円 </p>
            </div>
          </div>
          <div className='bg-gradient-to-br from-orange-400 via-orange-600 to-orange-400 w-75 h-50 rounded-xl p-4 flex justify-center items-center shadow-lg'>
            <div className=''>
           <p className='text-2xl text-center font-bold'>安定配信 </p>
            <p className='text-3xl text-center p-4 font-black'>月10～30万円 </p>
            </div>
          </div>
          <div className='bg-gradient-to-br from-orange-400 via-orange-600 to-orange-400 w-75 h-50 rounded-xl p-4 flex justify-center items-center shadow-lg'>
            <div className=''>
           <p className='text-2xl text-center font-bold'>継続的に活動</p>
            <p className='text-3xl text-center p-4 font-black'>月30万円以上も可能</p>
            </div>
          </div>
        </div>
        <p className='text-2xl text-black text-center p-5 w-100 justify-self-center'> まずは「時給収入」から無理なくステップアップできます。</p>
      </section>

      {/* この人にピッタリ */}
      <section className='bg-white py-20 px-6'>
        <h1 className='text-5xl text-black text-center font-bold'> モアプロはこんな人にピッタリ</h1>
        <div className='flex mx-auto justify-center items-center shadow-md rounded-xl bg-gray-300/20 p-4 mt-10 mb-10 w-125 h-100'>
          <div className='flex justify-center items-center text-2xl'>
            <ul className='text-black text-center　'>
              <li data-aos="fade-right" className="before:content-['✔'] before:p-2 before:text-green-500">
                未経験から配信を始めたい
              </li>
              <br></br>
              <li data-aos="fade-right" className="before:content-['✔'] before:p-2 before:text-green-500">
      ...
      {/* 応募 */}
      <section className='bg-white py-20 px-6'>
        <h1 className='text-5xl text-black text-center font-bold mx-auto'>応募からデビューまで</h1>
        <h1 className='text-5xl text-black text-center font-bold mx-auto p-4 mt-4'>たった3ステップ </h1>
        <div className='flex flex-row mx-auto justify-center items-center w-200 mt-10'>
          <div className='flex flex-col justify-center items-center'>
          <div className='flex flex-col justify-center items-center text-8xl mx-auto object-cover bg-gradient-to-br from-orange-400 via-orange-600 to-orange-400 rounded-full w-50 h-50 text-center'>
          1
          </div>
          <h1 className='text-2xl text-black text-center font-bold mx-auto p-10'>無料応募</h1>
          </div>
          <div className='flex flex-col mx-auto justify-center items-center  '>
          <div className='flex flex-col justify-center items-center text-8xl mx-auto object-cover bg-gradient-to-br from-orange-400 via-orange-600 to-orange-400 rounded-full w-50 h-50 text-center'>
          2
          </div>
          <h1 className='text-2xl text-black text-center font-bold mx-auto p-10'>オンライン面談</h1>
          </div>
          <div className='flex flex-col justify-center items-center'>
          <div className='flex flex-col justify-center items-center text-8xl mx-auto object-cover bg-gradient-to-br from-orange-400 via-orange-600 to-orange-400 rounded-full w-50 h-50 text-center'>
          3
          </div>
          <h1 className='text-2xl text-black text-center font-bold mx-auto p-10'>配信スタート</h1>
          </div>
        </div>
       <h1 className='text-2xl text-orange-500 text-center font-bold mx-auto p-10'>最短で、応募当日から開始も可能</h1>
      </section>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white text-center">
        <div className="container mx-auto">
          <h2 className="text-xl font-bold mb-6">ライブ配信はもう、一部の人だけの世界ではありません。</h2>
          <p className="text-3xl mb-8 mx-auto font-bold">BIGO LIVE × モアプロなら</p>
          <p className="text-3xl mb-8  mx-auto font-bold">&quot;誰でも、ちゃんと稼げる配信者になれる&quot;</p>
          <p className="text-xl mb-8 mx-auto font-bold">まずは気軽にご相談ください。</p>
          <div className="flex gap-4  md:pb-0 pb-15 justify-center text-center text-3xl">
            <Link href="/recruit" className="text-xl  shadow-lg px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full font-semibold hover:shadow-lg transition-transform hover:scale-105">
              今すぐ無料で応募する
            </Link>
            <Link href="/contact" className="text-xl  shadow-lg px-8 py-4 bg-gradient-to-l from-green-500 via-green-300 to-green-500  rounded-full font-semibold hover:bg-green-500 hover:shadow-lg transition-transform hover:scale-105">
              LINEでかんたん相談
            </Link>
          </div>
        </div>
