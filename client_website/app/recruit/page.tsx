            ...
            <div className="bg-white rounded-2xl w-200 shadow-lg min-h-screen mx-auto mt-10 pt-24 ">
                ...
                <div className="flex ">
                    <form className="grid grid-cols-1 items-center text-black gap-5 mt-15 px-10 ">
                        ...
                        <input required type="text" className="  outline outline-2 outline-orange-400 w-50 pl-3">
                        </input>
                        <label className="text-lg text-black ">
                            年齢
                        </label>
                        <input required type="number" className=" outline outline-2 outline-orange-400 w-50 pl-3">
                        </input>
                        <label className="text-lg text-black ">
                            メールアドレス
                        </label>
                        <input required type="email" className=" outline outline-2 outline-orange-400 w-50 pl-3">
                        </input>
                        <label className="text-lg text-black ">
                            お電話
                        </label>
                        <input required type="tel" className=" outline outline-2 outline-orange-400 w-50 pl-3">
                        </input>
                        <label className="text-lg text-black ">
                            現在の仕事
                        </label>
                        ...
                        <textarea required className=" outline outline-2 outline-orange-400 pl-3 pb-30 md:w-150">
                        </textarea>
